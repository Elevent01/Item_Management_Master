// app/icons/UomManagement.js
"use client";
import { usePanelWidth } from "../context/PanelWidthContext";
import { FolderOpen, Ruler, Calculator, LayoutDashboard } from 'lucide-react';
    ...
    <div style={{ padding: "20px", width: "100%", height: "100%", overflow: "auto" }}>
      ...
      <div style={{ marginBottom: "30px" }}>
        ...
        <p style={{ fontSize: "14px", color: "#666" }}>
          Unit of Measurement - Categories, Units, and Conversions
        </p>
      </div>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  gap: "12px",
                  padding: "12px 16px",
                  borderBottom: index < uomLinks.length - 1 ? "1px solid #f0f0f0" : "none",
                  cursor: "pointer",
      ...
      <div style={{ marginTop: "30px", padding: "16px", background: "linear-gradient(135deg, #d1fae5, #a7f3d0)", borderRadius: "8px", border: "1px solid #10b981" }}>
        ...
        <p style={{ fontSize: "12px", color: "#047857", lineHeight: "1.6", margin: 0 }}>
          The Unit of Measurement (UOM) system helps you manage standard units across your organization. 
          Create categories (Weight, Length, Volume), define units (KG, G, M, CM), and convert between them automatically.
        </p>
        <div style={{ marginTop: "12px", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(150px, 1fr))", gap: "8px" }}>
          <div style={{ background: "white", padding: "8px", borderRadius: "4px", fontSize: "11px" }}>
            <strong style={{ color: "#047857" }}>Categories:</strong> Group related units
          </div>
          <div style={{ background: "white", padding: "8px", borderRadius: "4px", fontSize: "11px" }}>
            <strong style={{ color: "#047857" }}>Units:</strong> Define conversion factors
          </div>
          <div style={{ background: "white", padding: "8px", borderRadius: "4px", fontSize: "11px" }}>
            <strong style={{ color: "#047857" }}>Converter:</strong> Instant conversions
          </div>
        </div>
      </div>
    </div>
