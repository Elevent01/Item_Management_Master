// app/icons/VishalMaster.js
"use client";
import { usePanelWidth } from "../context/PanelWidthContext";
import { vishalLinks } from "../config/vishalLinks";

export default function VishalMaster() {
    ...
    <div style={{ padding: "20px", width: "100%", height: "100%", overflow: "auto" }}>
      ...
      <div style={{ marginBottom: "30px" }}>
        ...
        <p style={{ fontSize: "14px", color: "#666" }}>
          Manage vishal settings and configurations
        </p>
      </div>
